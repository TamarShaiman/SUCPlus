...
def main(result_dir_name, tmp_dir_name): #added result_dir_name, tmp_dir_name
    ...
    execution_time = open("./result2/execution_time" + ".txt", 'w')
    execution_time.write(str(elapsed_time))

    rec_list = open("./result2/reclist_top_" + str(top_k) + ".txt", 'w')
    result_5 = open("./result2/result_top_" + str(5) + ".txt", 'w')
    result_10 = open("./result2/result_top_" + str(10) + ".txt", 'w')
    result_15 = open("./result2/result_top_" + str(15) + ".txt", 'w')
    result_20 = open("./result2/result_top_" + str(20) + ".txt", 'w')
