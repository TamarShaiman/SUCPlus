...
class LFBCA_optimize(object):
    ...
    # Lior Added:
    # --------------------------------------------------------------------
    def compute_graph_centrality(self, social_matrix, centrality_type='betweenness'):
        try:
            ...
            if centrality_type == 'eigenvector':
                ...
                raise ValueError(
                    "Unknown centrality type: {centrality_type}. Choose from ['eigenvector', 'closeness', 'betweenness', 'degree']."
                )
    ...
    def precompute_user_social_similarities(self, check_in_matrix, social_matrix, centrality_type='betweenness'):
        C = check_in_matrix
    ...
    def precompute_rec_scores(self, check_in_matrix, social_matrix, centrality_type='betweenness'):
        ...
        # Lior Added:
        # --------------------------------------------------------------------
        gamma = 0  # Weight for outward influence
        ...
        inward_influence = (all_ppr.T).dot(normalized_check_in_matrix)
